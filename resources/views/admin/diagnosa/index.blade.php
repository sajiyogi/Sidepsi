        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">                                          <a href="{{route('diagnosa.create')}}" class="btn btn-info m-t-15 waves-effect">Add New</a>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <tr>                                        	
                                               ...
                                               <td>
                                                <a href="{{route('diagnosa.edit',$diagnosa->id)}}" class="btn btn-warning waves-effect">Edit</a>
                                            </td>
                                            	<td>
                                            		<form id="delete_form" method="POST" action="{{ route('diagnosa.destroy',$diagnosa->id) }}">
    					                            	{{ csrf_field() }}
