...
@section('content')
        ...
        <span class="input-group-addon">
            ...
            <input type="text" class="form-control" name="nama_lengkap" value="{{$user->nama_lengkap}}" placeholder="Nama Lengkap" required autofocus>
        </div>
    </div>
    ...
    <div class="input-group">
        ...
        <span class="input-group-addon">
            ...
            <input id="tanggal_lahir" type="date" class="form-control" name="tanggal_lahir" value="{{$user->tanggal_lahir}}" placeholder="tanggal_lahir" required autofocus>
        </div>
        </div>
     <div class="input-group">
        <span class="input-group-addon">
            ...
            <input type="text" class="form-control" name="perusahaan" value="{{$user->tanggal_lahir}}" placeholder="Perusahaan" required autofocus>
        </div>
        </div>                               
