            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Karyawan</h2>
                            <a href="{{route('users.create')}}" class="btn btn-success btn-block m-t-15 waves-effect">Tambah Karyawan</a>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>                                        	
                                            ...
                                            <td>
                                                <a href="{{route('users.edit',$row->id)}}" class="btn btn-warning waves-effect">Beri Akses</a>
                                            </td>
                                        	<td>
