 ...
 -->            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">                                          <a href="{{route('artikel.create')}}" class="btn btn-info m-t-15 waves-effect">Tambah Artikel</a>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <tr>                                        	
                                                ...
                                                <td>
                               <img src="{{ URL::to('/') }}/images/{{ $artikel->gambar }}"  alt="" style="width: 160px; height: 190px;" /></td>
                                                <td>{{ $artikel->created_at }} </td>
                                                <td>{{ $artikel->updated_at }} </td>
                                                                                                
                                               <td>
                                                <a href="{{route('artikel.edit',$artikel->id)}}" class="btn btn-warning waves-effect">Edit</a>
                                            </td>
                                            	<td>
                                            		<form id="delete_form" method="POST" action="{{ route('artikel.destroy',$artikel->id) }}">
    					                            	{{ csrf_field() }}
