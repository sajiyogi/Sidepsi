                        ...
                        <div class="body">                        	
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <form  method="POST" action="{{url('/hasildeteksiverified')}}">
                                                        {{ csrf_field() }}
                                            ...
                                            <tr>                                        	
                                                ...
                                                <!-- <div class="demo-radio-button">
                                                    <input name="pilihan[]" type="radio" id="radio_1" value="0">
                                                    <label for="radio_1">TS</label>
                                                    <input name="pilihan[]" type="radio" id="radio_2" value="0.3">
                                                    <label for="radio_2">SS</label>
                                                    <input name="pilihan[]" type="radio" id="radio_3" value="0.8">
                                                    <label for="radio_3">HS</label>
                                                    <input name="pilihan[]" type="radio" id="radio_4" value="1">
                                                    <label for="radio_4">Setuju</label> -->
                                                    <select name="pilihan[]" class="gg">
                                                    
                                          <option value="0" selected>PILIH</option>
                                          <option value="0">TIDAK SETUJU</option>
                                          <option value="0.3">SEDIKIT SETUJU</option>
                                          <option value="0.8">HAMPIR SETUJU</option>
